...
class WellInfo(Base):
    ...
    Qtr_Qtr = sql.Column(sql.VARCHAR(255))
    section = sql.Column(sql.VARCHAR(255))
    township = sql.Column(sql.VARCHAR(255))
    range = sql.Column(sql.VARCHAR(255))
    well_status = sql.Column(sql.VARCHAR(255))
    well_type = sql.Column(sql.VARCHAR(255))
    closest_city = sql.Column(sql.VARCHAR(255))
    barrels_produced = sql.Column(sql.VARCHAR(255))
    mcf_gas_produced = sql.Column(sql.VARCHAR(255))
